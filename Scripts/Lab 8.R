...
# Simulating vowel durations for a mixed model analysis:
...
# --------------------------------------------------------
# Analyzing the simulated vowel durations with mixed models:
...
# --------------------------------------------------------
# Computing R-squared for mixed models:
...
# --------------------------------------------------------
# Mixed logistic regression: Ugly selfies

# Load data:

selfie <- read_csv('/path_to/ruth_page_selfies.csv')
